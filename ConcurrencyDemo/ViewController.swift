...
class ViewController: UIViewController {
    ...
    @IBAction func didClickOnStart(sender: AnyObject) {
        ...
        dispatch_async(queue) { 
            let img1 = Downloader.downloadImageWithURL(imageURLs[0]) // background thread
            
            dispatch_async(dispatch_get_main_queue(), { 
                self.imageView1.image = img1 // main thread (UI stuff)
            })
    ...
    @IBAction func didClickOnStart2(sender: AnyObject) {
